...
def set_params(df, list_col): 
    ...
    with col2:
        ...
        stop = st.number_input('The number of repeated solutions', value=10, help=' Number of iterations for stopping criteria when solution does not improve.', min_value=0, step=1)
